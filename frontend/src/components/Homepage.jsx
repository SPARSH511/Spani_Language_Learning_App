    ...
    <div className="wrapper">
      ...
      <main className="main">
        ...
        <div className="content">
          <div>
            <p>
              Welcome to our Spanish Learning App where you can too master it
              like the natives do !
            </p>
            <p>
              Sign up for Spanio+ today and embark on a learning adventure like
              never before. Learn new languages with assorted quiz and an
              associated learning material
            </p>
        ...
        <div class="container">
          ...
          <div class="right">
            <div class="image-wrapper">
              <img src={image} class="img" alt="upload" />
              <div class="wave-wrap">
                <svg
                  class="wave"
              ...
              >
                <path
                  id="dashed-wave"
                  d="M0.5 876C25.6667 836.167 73.2 739.8 62 
